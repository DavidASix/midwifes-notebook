...
- Form controls: text inputs use a compact 40-point height; date selectors and segmented choices use a denser 36-point
  visual height, while primary actions and disclosure headers retain a 44-point touch target
